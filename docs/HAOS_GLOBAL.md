...
6. [Slack — Configuração de Canais](#6-slack--configuração-de-canais)
7. [Rito v2 — Pipeline Completo](#7-rito-v2--pipeline-completo)
8. [Skills — Lista Completa](#8-skills--lista-completa)
9. [Quick Commands — Referência Rápida](#9-quick-commands--referência-rápida)
10. [Diferenças Linux vs Windows](#10-diferenças-linux-vs-windows)
...
# 6. SLACK — CONFIGURAÇÃO DE CANAIS
...
# 9. QUICK COMMANDS — REFERÊNCIA RÁPIDA
...
# 10. DIFERENÇAS LINUX VS WINDOWS
